...
//
// Related Topics 哈希表 链表 双指针 👍 2324 👎 0
...
public class Test160 {
    ...
    @Test
    public void test() {
        ListNode nodeA = new ListNode(4, new ListNode(8, new ListNode(9)));
        ListNode nodeB = new ListNode(5, new ListNode(6));
        /*ListNode node = new ListNode(1, new ListNode(8, new ListNode(4, new ListNode(5))));
        nodeA.next = node;
        nodeB.next = node;*/
