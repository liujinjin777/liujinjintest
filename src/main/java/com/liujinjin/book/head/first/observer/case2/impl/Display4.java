 ...
 * @date 2018/6/19
 */
public class Display4 implements java.util.Observer, DisplayElement{

    private Subject subject;
    private float temperature;
    private float humidity;

    public Display4(Subject subject){
    ...
    @Override
    public void display() {
        System.out.println(String.format("Display4 temperature=%s, humidity=%s", this.temperature, this.humidity));
    }
