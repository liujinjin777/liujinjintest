 ...
 * @date 2018/6/19
 */
public class Display3 implements java.util.Observer, DisplayElement{
    ...
    @Override
    public void display() {
        System.out.println(String.format("Display3 temperature=%s, humidity=%s", this.temperature, this.humidity));
    }
